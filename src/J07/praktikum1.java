...
public class praktikum1 {
    public static void main(String[] args){
        ...
        if(a < 5){
            ...
            System.out.println("nilai a lebih dari sama dengan 5");
        
        System.out.println("\nIF..ELSE IF..ELSE.. 2");
        if(a < 2){
            System.out.println("niali a kurang dari 2");
        } else if(a < 4) {
            System.out.println("nilai a kurang dari 4");
        } else if(a < 6) {
            System.out.println("niali a kurang dari 6");
        } else if(a == 6) {
        ...
        switch(a){
            ...
            case 3: 
            case 4: System.out.println("bilai a => 3 atau 4"); break;
